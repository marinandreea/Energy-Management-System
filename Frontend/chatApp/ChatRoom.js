...
const ChatRoom = () =>{
    ...
    // useEffect(() => {
    //     console.log(userData);
    //     if (userData.username && !stompClient?.connected) {
    //         registerUser();
    //     }
    // }, [userData, stompClient]);
    ...
    const handleTyping = (event) => {
        ...
        if (value.trim() !== "" && !isTyping) {
          ...
          // User started typing
          stompClient.current.send('/app/typing', connectOptions, JSON.stringify({ senderName: userData.username, receiverName: tab, status: 'TYPING' }));
          ...
          // User stopped typing
          stompClient.current.send('/app/typing', connectOptions, JSON.stringify({ senderName: userData.username, receiverName: tab, status: 'STOP_TYPING' }));
    ...
    return (
        <div className='containerChatRoom'>
            ...
            (   <div className='chat-box'>
                    ...
                    {(isTyping) && <li className='message'>
                        ...
                        {[...privateChats.get(tab)].map((chat,index)=>(
                          ...
                          <div className='send-message'>
                            <input type='text' className='input-message' name='message' placeholder={`enter private message for ${tab}`} value={userData.message} onChange={handleTyping}/>
            ...
            //         <input id='user-name' name='username' placeholder='Enter the user name' value={userData.username} onChange={handleValue}></input>
