...
public class JwtService {
    ...
    public String generateToken(UserDetails userDetails){
        ...
        // Include the user's role(s) in the claims
        if (userDetails instanceof Userr) {
            Userr customUser = (Userr) userDetails;
    ...
    public boolean isTokenValid(String token, UserDetails userDetails){
        ...
        return (username.equals(userDetails.getUsername())) && isTokenSignatureValid(token) && !isTokenExpired(token);
    }
